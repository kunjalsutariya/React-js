    ...
    return (
        <div align="center">
            <header className='d-flex  justify-content-between' style={{ backgroundColor: "#444444", padding: "10px", maxWidth: "924.66px", marginTop: "20px" }} >
                ...
                <div >
                    <Link to={`/`} className="btn   justify-content-end" style={{ color: "#fff" }}><IoAddCircle style={{ fontSize: "40px" }} /></Link>
                </div>
            </header>
                        ...
                        return (
                            <div className=" main-box d-flex align-items-center justify-content-around  text-start p-3   border" key={val.id}>
                                ...
                                <div className="col-4 d-flex justify-content-end">
                                    <button onClick={() => deleteRecord(val.id)} className='btn ' style={{ fontSize: "18px" }}><MdDelete style={{ fontSize: "25px" }} /></button>
                                </div>
                            </div>
                        );
                    })}
